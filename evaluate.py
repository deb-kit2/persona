...
def generate(model, data, tokenizer, args) :
    ...
    with open("generation_results/" + args.model + "/" + args.output_json_name) as fi :
...
if __name__ == "__main__" :
    ...
    # load model
    model = BartForPersonaAwareGeneration.from_pretrained(args.model)
    model.to(DEVICE)
    model.eval()
